...
Gmeet.prototype.join = async function (url, email, password, obs, obs_config, name, camera, options = {}) {
	...
	var recording = {
		captions: {
			rec: "body > div.JPdR6b.e5Emjc.CIYi0d.jvUMfb.yOCuXd.qjTEB > div > div > span:nth-child(7)",
			not: "body > div.JPdR6b.e5Emjc.CIYi0d.jvUMfb.yOCuXd.qjTEB > div > div > span:nth-child(5)"
		}
	}
	...
	do {
		try {
			...
			await page.click("#ow3 > div.T4LgNb > div > div:nth-child(8) > div.crqnQb > div.rG0ybd.LCXT6 > div.q2u11 > div.a1GRr > div"); // mute mic

			await delay('750');

			await page.click("#ow3 > div.T4LgNb > div > div:nth-child(8) > div.crqnQb > div.rG0ybd.LCXT6 > div.q2u11 > div.SfBQ6c"); // turn off camera



			// obs start record
			if (obs == 'yes') {
				await page.click("#ow152 > div > span > span"); // ... memu
				await delay('1500');
				// check for recoding
				...
				var recordingCall_str = `${recordingCall}`; // i dont know why this works but it does
				if (recordingCall != undefined) {
					if (recordingCall_str.includes("recorded")) {
						var captions = recording.captions.rec;
					} else {
						var captions = recording.captions.not;
					}
				} else {
					var captions = recording.captions.not;
				}
				await delay('750');
				await page.click(captions); //captions 
				await delay('1500');
			...
			async function sendLateChat() { // chat 
				await delay('750');

				await page.click("#ow3 > div.T4LgNb > div > div:nth-child(8) > div.crqnQb > div.pHsCke > div.Jrb8ue > div > div.NzPR9b > div:nth-child(3) > span"); // chat button

				await delay('750');

				await page.type("#ow3 > div.T4LgNb > div > div:nth-child(8) > div.crqnQb > div.mKBhCf.qwU8Me.RlceJe.kjZr4 > div > div.Bx7THd.PBWx0c.Uy7Qke.XN1AMe > div.ZHdB2e.iy732 > div.fe4pJf.Pdo15c > span.HALYaf.u92yl.KKjvXb > div > div.BC4V9b > div.edhGSc.zKHdkd.XnKlKd > div.RpC4Ne.oJeWuf > div.Pc9Gce.Wic03c > textarea", "Sorry im late", {
					delay: 5
				}); // type in  chat

				await delay('5000');

				await page.click("#ow3 > div.T4LgNb > div > div:nth-child(8) > div.crqnQb > div.mKBhCf.qwU8Me.RlceJe.kjZr4 > div > div.Bx7THd.PBWx0c.Uy7Qke.XN1AMe > div.ZHdB2e.iy732 > div.fe4pJf.Pdo15c > span.HALYaf.u92yl.KKjvXb > div > div.BC4V9b > div.uArJ5e.Y5FYJe.cjq2Db.IOMpW.Cs0vCd > span"); // send chat

				await delay('750');

				await page.click("#ow3 > div.T4LgNb > div > div:nth-child(8) > div.crqnQb > div.mKBhCf.qwU8Me.RlceJe.kjZr4 > div > div.Bx7THd.PBWx0c.Uy7Qke.XN1AMe > div.CYZUZd > div.VUk8eb > div > span > button"); // x button}
			}
			...
			async function peopleInCall() {
				...
				if (peopleInCall <= 5) { // you can change the 2 to any number but i wouldnt recommend going above 5
